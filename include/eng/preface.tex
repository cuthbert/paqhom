...
read MO's main book on the subject, entitled \I{The Klingon
...
\noindent\parbox[t]{.5\textwidth}{%
  ...
  \rule{1.25cm}{0mm}Villav\ägen 33, 2tr\\
...
date given in \mbox{\I{YYYY-MM-DD}} format. If you want to identify or
...
\I{Klingonska Akademien} website (\I{www.klingonska.org}) some additional
information can also be found in \I{The Klingon Mailing List FAQ}
(\I{www.bigfoot.com/\linebreak \¡\×\,dspeers/klingon/faq.htm}).
...
\phonexpl{D}%
  {\textipa{[\:d]} As in Swedish \I{v\ä\U{rd}} (host), further back
...
\phonexpl{S}%
  {\textipa{[\:s]} As in Swedish \I{moth\å\U{rs}} (against the
